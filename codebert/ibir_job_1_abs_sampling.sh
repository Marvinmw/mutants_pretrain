...
bash run_mask_prediction_sampling.sh ibir_context_abs_sampling Cli Codec Collections train_0 ../data/data_ibir_abs_token_diff.jsonl_context
bash run_mask_prediction_sampling.sh ibir_context_abs_sampling Compress Csv Gson train_1 ../data/data_ibir_abs_token_diff.jsonl_context
